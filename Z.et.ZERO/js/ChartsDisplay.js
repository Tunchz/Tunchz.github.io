...
*/
        Axes = function(data) {
            ...
            var maxC = d3.max(data, function(d) { return d.humd; });
            var maxDC = d3.max([maxD, maxD/*maxC*/]);

            var minD = d3.min(data, function(d) { return d.pm25; });
            var minC = d3.min(data, function(d) { return d.humd; });
            var minDC = d3.min([minD, minD/*minC*/]);
