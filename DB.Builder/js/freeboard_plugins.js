...
function FreeboardModel(a, b, c) {
    ...
    this.min_cols = ko.observable(), this.min_cols.subscribe(function(a){document.body.style.minWidth = !_.isUndefined(a)?(parseInt(a)*106-6+20+'px'):_default.min_width}),
    ...
    this.plugins = ko.observableArray(), this.datasources = ko.observableArray(), this.panes = ko.observableArray(), this.datasourceData = {}, this.processDatasourceUpdate = function(a, b) {
        ...
        if (d.allow_edit() || !a) {
            ...
            a ? ($("#toggle-header-icon").addClass("icon-chevron-up").removeClass("icon-chevron-down"), $(".gridster .gs_w").css({
                ...
                top: f + 30 + "px"
            }, e), $("#board-content-bottom").addClass("edited")
            , $("#main-header").data().shown = !0, c.attachWidgetEditIcons($(".sub-section")), c.enableGrid())

            : ($("#toggle-header-icon").addClass("icon-chevron-down").removeClass("icon-chevron-up"), $(".gridster .gs_w").css({
                cursor: "default"
            }), $("#main-header").animate({
                top: "-" + f + "px"
            }, e), $("#board-content").animate({
                top: "0"
            }, e), $("#board-content-bottom").removeClass("edited")
            , $("#main-header").data().shown = !1, $(".sub-section").unbind(), c.disableGrid()), c.showPaneEditIcons(a, b)
        }
