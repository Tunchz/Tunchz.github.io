...
(function()
{
    ...
    freeboard.addStyle ('.myui-slider-handle', 'width:11px !important; height:19px !important; margin-left:-4px !important;');
	...
	var slider = function(settings)
	{
		...
		{
                        $(containerElement).parent().css({"margin-bottom": _r*2+"px"})
                        $(containerElement)
